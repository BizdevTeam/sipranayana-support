                ...
                <div class="row mb-2">
                    <div class="col-sm-12 px-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="m-0 text-bold">Management Users</h3>
                            ...
                            @include('admin.components.form.addUsers')
                        </div>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <table id="example2" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($user as $item)
                                        ...
                                        <td style="width: 150px;">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="actionMenu{{ $item->id }}">
                                                    ...
                                                    <form action="{{ route('admin.delete.users', $item->id) }}"
                                    ...
                                    <!-- Modal Edit -->
                                    @include('admin.components.form.updateUser')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
