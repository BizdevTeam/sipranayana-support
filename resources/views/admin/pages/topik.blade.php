                ...
                <div class="row mb-2">
                    <div class="col-sm-12 px-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="m-0 text-bold">Management Topik Permasalahan</h3>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addTopicModal">
                                <i class="fa fa-plus-circle"></i> Tambah Topik Permasalahan
                            </button>
                            @include('admin.components.form.addTopic')
                        </div>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                            ...
                            <tbody>
                                ...
                                @foreach ($topic as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            @if ($item->status == 'Belum Tervalidasi')
                                        ...
                                        <td style="width: 150px;">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="actionMenu{{ $item->id }}">
                                                    ...
                                                    <form action="{{ route('admin.delete.topic', $item->id) }}"
                                    ...
                                    <!-- Modal Edit -->
                                    @include('admin.components.form.updateTopic')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
